...
def generate_launch_description():
    ...
    gz_pkg_share = launch_ros.substitutions.FindPackageShare(package="mark_gazebo").find(
        "mark_gazebo"
    )

    declare_robot_name = DeclareLaunchArgument("robot_name", default_value="MARK")
    ...
    pkg_share = launch_ros.substitutions.FindPackageShare(package="mark_description").find("mark_description")
    default_model_path = os.path.join(pkg_share, "urdf/mark.urdf.xacro")
    ...
    gazebo_config = os.path.join(launch_ros.substitutions.FindPackageShare(
        package="mark_gazebo"
    ).find("mark_gazebo"), "config/gazebo.yaml")
