...
def generate_launch_description():
    ...
    descr_pkg_share = launch_ros.substitutions.FindPackageShare(
        package="mark_description"
    ).find("mark_description")
    ...
    default_model_path = os.path.join(descr_pkg_share, "urdf/mark.urdf.xacro")
    ...
    declare_robot_name = DeclareLaunchArgument(
        "robot_name", default_value="mark", description="Robot name"
    )
    ...
    bringup_ld = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(
                get_package_share_directory("mark_bringup"),
                "launch",
                "bringup.launch.py",
            )
        ),
    ...
    gazebo_ld = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(
                get_package_share_directory("mark_gazebo"),
                "launch",
                "gazebo.launch.py",
            )
        ),
