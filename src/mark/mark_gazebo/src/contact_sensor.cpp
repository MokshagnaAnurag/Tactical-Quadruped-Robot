...
class ContactSensor: public rclcpp::Node
{
	...
	rclcpp::Publisher<mark_msgs::msg::ContactsStamped>::SharedPtr contacts_publisher_;
	...
	public:
                        ...
                        .automatically_declare_parameters_from_overrides(true))
		{
			...
			joint_names = mark::URDF::getLinkNames(this->get_node_parameters_interface());
			...
			contacts_publisher_   = this->create_publisher<mark_msgs::msg::ContactsStamped>("foot_contacts", 10);
