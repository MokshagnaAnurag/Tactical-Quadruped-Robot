...
def generate_launch_description():
    ...
    pkg_share = launch_ros.substitutions.FindPackageShare(package="mark_config").find("mark_config")
    config = os.path.join(pkg_share, "config/joints/joints.yaml")

    declare_description_name = DeclareLaunchArgument("description_name", default_value="mark", description="Robot description")
